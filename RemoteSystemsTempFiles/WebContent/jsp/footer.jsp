...
<div id="templatemo_bottom_wrapper">
	<div id="templatemo_bottom">
    	...
    	<div class="col one_fourth">
            ...
            <ul class="footer_gallery">
            	<li><a href="images/templatemo_image_06_l.jpg"  rel="lightbox[portfolio]"><img src="/Sportsclub/images/10.jpg" alt="image 6" /></a></li>
    	...
    	<div class="col one_fourth">
    	<h4>Recent <a href="#"   class="recent_post" target="_blank">Posts</a></h4>
        <ul class="no_bullet">
            <li>
                <span class="header"><a href="#">Sachin Tendulkar</a></span>
                <i>I am Glad to be part of such a Prestigious Club... </i>
            </li>
            <li>
                <span class="header"><a href="#"><strong>CLUB</strong> </a></span>
                <i>We are happy to celebrate first 1000 players joining in club.</i>
            </li>
                <li>
                <span class="header"><a href="#">New York Times...</a></span>
               <i>One of World's Best Leading SportsClub</i>......
            </li>
		</ul>
    </div>
    ...
    <div id="templatemo_footer" style="text-align:right"><h6>
    	<p>Copyright 2014 <a href="https://www.facebook.com/prashant.singh.501151"><i>SportsClub</i> </a></br> <br>
        	All rights reserved by<a rel="nofollow" href="http://www.thakurprashantsingh.webs.com">Club Administator</a>  </p></h6>
